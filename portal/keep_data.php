...
<section id="content">
	<div class="zerogrid">
		<div class="row block offbottom">
			...
			<div class="mymain2">
			<h3 align="center">Keep Your Data</h3>
            <form action="draft.php" enctype="multipart/form-data" method="post">
            	<table>
                    ...
                    <tr>
                    	<td colspan="2" align="right">Input your data:
                        </td>
                    	<td colspan="4">&nbsp;<textarea class="textb2" placeholder="Input your information here" required rows="6" name="sdata"></textarea>
                        </td>
                    </tr>
                    <tr>
