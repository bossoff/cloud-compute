		...
		<div class="row block offbottom">
            ...
            <form action="add_user.php" enctype="multipart/form-data" method="post">
            	<table>
                    ...
                    <tr>
                    	<td style="padding:10px;" colspan="2" align="right">Surname:
                        </td>
                    	<td colspan="4">&nbsp;<input type="text" class="textb2" name="surname" required />
                        </td>
                    </tr>
                    <tr>
                    	<td style="padding:10px;" colspan="2" align="right">Othername:
                        </td>
                    	<td colspan="4">&nbsp;<input type="text" class="textb2" name="othername" required />
                        </td>
                    </tr>
                    <tr>
                    	<td style="padding:10px;" colspan="2" align="right">Phone No:
                        </td>
                    	<td colspan="4">&nbsp;<input type="text" class="textb2" name="phone_no" required />
                        </td>
                    </tr>
                    <tr>
                    	<td colspan="6" align="center">
                        				<input type="submit" class="sub" value="Generate Passcode" style="cursor:pointer;" />
